...
public class PlayerDamping : NetworkBehaviour
{
        ...
        private void FixedUpdate()
        {
                ...
                if (!_dampingLocked)
                {
                        ...
                        float maxMoveSpeed = playerMovement.MaxControllableSpeed;
                        
                        float targetDamping = hVel > maxMoveSpeed ? groundTooFastDamping : groundNormalDamping;
                        targetDamping = PlayerGrounded.IsOnControllableSlope ? targetDamping : 1;
