...
Shader "SyntyStudios/WaterShader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _DeepColour;
			half4 _DepthGlowColour;
			float4 _FoamColor;
			half4 _FoamEmitColour;
			half4 _CausticColour;
			float4 _ShallowColour;
			float4 _VeryDeepColour;
			half _GlowDepth;
			half _GlowFalloff;
			half _FoamGlowMultiplier;
			half _CausticScale;
			float _WaveSpeed;
			half _CausticSpeed;
			...
			float _NormalScale;
			half _NormalTiling2;
			half _WaveFoamOpacity;
			float _RippleSpeed;
			half _WaveNoiseScale;
			half _WaveNoiseAmount;
			half _WaveDirection;
			half _WaveWavelength;
			float _WaveAmplitude;
			float _Depth;
			float _OverallFalloff;
			half _ShallowFalloff;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half mulTime307 = _TimeParameters.x * 0.001;
				half2 temp_cast_1 = (mulTime307).xx;
				half2 texCoord312 = v.texcoord.xy * float2( 1,1 ) + temp_cast_1;
				half simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
						 ...
						 ) : SV_Target
			{
				...
				half distanceDepth170 = abs( ( screenDepth170 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _Depth ) );
				...
				half2 appendResult19 = (half2(WorldPosition.x , WorldPosition.z));
				...
				half4 Refraction107 = fetchOpaqueVal100;
				half4 lerpResult121 = lerp( temp_output_175_0 , Refraction107 , temp_output_175_0);
				half2 temp_output_14_0 = (WorldPosition).xz;
				...
				half2 texCoord26 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				half2 panner37 = ( 1.0 * _Time.y * float2( -0.01,0.01 ) + texCoord26);
				...
				half mulTime307 = _TimeParameters.x * 0.001;
				half2 temp_cast_6 = (mulTime307).xx;
				half2 texCoord312 = IN.ase_texcoord7.xy * float2( 1,1 ) + temp_cast_6;
				half simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				half2 appendResult59 = (half2(WorldPosition.x , WorldPosition.z));
				float cos302 = cos( _WaveDirection );
				float sin302 = sin( _WaveDirection );
				half2 rotator302 = mul( ( ( simplePerlin2D320 * _WaveNoiseAmount ) + appendResult59 ) - float2( 0,0 ) , float2x2( cos302 , -sin302 , sin302 , cos302 )) + float2( 0,0 );
				half2 temp_output_60_0 = ( rotator302 * _WaveWavelength );
				half2 panner70 = ( 1.0 * _Time.y * temp_cast_5 + temp_output_60_0);
				half2 temp_output_13_0 = (WorldPosition).xz;
				...
				half4 lerpResult97 = lerp( temp_cast_4 , tex2D( _FoamMask, panner70 ) , waveCrestNoise0277);
				half2 temp_output_25_0 = (WorldPosition).xz;
				...
				half4 lerpResult109 = lerp( temp_cast_3 , lerpResult97 , waveCrestNoise0182);
				...
				half2 temp_cast_12 = (_RippleSpeed).xx;
				half2 appendResult93 = (half2(WorldPosition.x , WorldPosition.z));
				half2 panner119 = ( 1.0 * _Time.y * temp_cast_12 + ( appendResult93 * _NormalTiling ));
				half2 temp_cast_14 = (-_RippleSpeed).xx;
				half2 panner118 = ( 1.0 * _Time.y * temp_cast_14 + ( appendResult93 * _NormalTiling2 ));
				half3 unpack151 = UnpackNormalScale( half4( BlendNormal( tex2D( _RipplesNormal, panner119 ).rgb , UnpackNormalScale( tex2D( _RipplesNormal2, panner118 ), 1.0f ) ) , 0.0 ), _NormalScale );
				unpack151.z = lerp( 1, unpack151.z, saturate(_NormalScale) );
				half3 waveNormalMaps157 = unpack151;
				
				float screenDepth333 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				half distanceDepth333 = abs( ( screenDepth333 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _GlowDepth ) );
				...
				half mulTime90 = _TimeParameters.x * _CausticSpeed;
				half time110 = mulTime90;
				half2 voronoiSmoothId110 = 0;
				...
				half distanceDepth237 = abs( ( screenDepth237 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _CausticDepthFade ) );
				...
				half distanceDepth234 = abs( ( screenDepth234 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				half mulTime307 = _TimeParameters.x * 0.001;
				half2 temp_cast_1 = (mulTime307).xx;
				half2 texCoord312 = v.ase_texcoord.xy * float2( 1,1 ) + temp_cast_1;
				half simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				half2 appendResult59 = (half2(ase_worldPos.x , ase_worldPos.z));
				float cos302 = cos( _WaveDirection );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 panner22 = ( 0.1 * _Time.y * float2( -1,0 ) + temp_output_14_0);
				half simplePerlin3D43 = snoise( half3( ( panner22 * 3 ) ,  0.0 ) );
				half2 texCoord26 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				half2 panner37 = ( 1.0 * _Time.y * float2( -0.01,0.01 ) + texCoord26);
				half foam62 = ( saturate( pow( ( distanceDepth170 + _FoamShoreline ) , _FoamFalloff ) ) * tex2D( _Foam_Texture, panner37 ).r );
				half4 foamNoise114 = saturate( ( ( _FoamColor * ( 1.0 - step( ( simplePerlin3D44 + simplePerlin3D43 ) , ( distanceDepth170 * _FoamSpread ) ) ) ) + ( _FoamColor * foam62 ) ) );
				half4 lerpResult141 = lerp( lerpResult121 , float4(1,1,1,0) , foamNoise114);
				...
				half mulTime307 = _TimeParameters.x * 0.001;
				half2 temp_cast_6 = (mulTime307).xx;
				half2 texCoord312 = IN.ase_texcoord3.xy * float2( 1,1 ) + temp_cast_6;
				half simplePerlin2D320 = snoise( texCoord312*_WaveNoiseScale );
				half2 appendResult59 = (half2(WorldPosition.x , WorldPosition.z));
				float cos302 = cos( _WaveDirection );
				float sin302 = sin( _WaveDirection );
...
/*ASEBEGIN
Version=18935
-2964;5;2466;1355;1688.057;412.6781;1;True;True
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;345;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;342;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;SyntyStudios/WaterShader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;0;638003455575877150;Surface;1;638003455593763994;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;343;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;344;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=EC7E87526B827870DFD24BFC269D49945035CEAC